...
class DiskApi {
    constructor(config, db, getUserFromUsername, sessionValidator, router = express_1.Router(), errorHandler = tiny_host_common_1.handleError) {
        this._router = router;
